<template>
    ...
    <strong>168红衣导航 www.168dh.cn</strong><br />
		<p style="text-align: left;">发现、收集、整理全网高质量的产品、网站、工具、文章、APP等资源，希望为每位用户提供良好的上网体验。</p><br />
		(如有问题联系邮箱<u><em><strong>38707145@qq.com</strong></em></u>)
    </el-dialog>
