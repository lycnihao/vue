<template>
	 <div class="sidebar_block" v-show="show" :class="{'animation-out':!show}">
		<ul>
			<!-- <li class="item">
				<a>搜索</a>
...
.animation-out{
	animation: sidebar_block_hide 1s forwards;
}

@keyframes sidebar_block_hide {
  0% {
...
.sidebar_block .item:hover .el-backtop a{
	left: 8px!important;
}
